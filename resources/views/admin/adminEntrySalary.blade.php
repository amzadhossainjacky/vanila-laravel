    ...
    <div id="wrapper">
        ...
        <div class="sidebar">
            <ul>
                ...
                <li>
                    <i class="fas fa-hands-helping"></i> <a class="ad-active"  href="entry_salary.html">Entry Salary</a>
                </li>
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <h1 class="mt-5 mb-4">Entry Salary</h1>
                        ...
                        <form class="mt-2" method="POST" action="{{route('admin.entrySalary')}}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                              ...
                              <input class="form-control" id="amount" placeholder="amount value" name="amount">
                            </div>
